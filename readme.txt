=== ACF Page Level ===
Contributors: navzme
Tags: core, admin, site, frontend, acf, advanced, custom, fields, page, level, hierarchy
...
1. Upload the plugin folder \'acf-page-level\' to the `/wp-content/plugins/acf-page-level` directory, or install the plugin through the WordPress plugins screen directly.
